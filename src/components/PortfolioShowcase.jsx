...
const projects = [
  ...
  },
  {
    ...
    desc: 'Agente IA con Groq + Gemini para scraping de negocios en Google Business.',
    url: 'https://digitalmza.vercel.app',
    github: 'https://github.com/pablo2389/digital-flow',
    tags: ['IA', 'Groq', 'Gemini', 'Maps API'], highlight: true,
  },
  {
    id: 'p3', title: 'App Lavadero',
    desc: 'Gestión de turnos con Firebase y envío automático por WhatsApp.',
    url: 'https://lavadero-appone.vercel.app',
    github: 'https://github.com/pablo2389/lavadero-app',
    tags: ['Firebase', 'WhatsApp', 'Vercel'], highlight: true,
  },
  {
    id: 'p4', title: 'Perfume Low Cost',
    desc: 'Tienda online con carrito, Cloudinary, modo admin y pedidos por WhatsApp.',
    url: 'https://perfume-lowcost.netlify.app',
    github: 'https://github.com/pablo2389/Perfumeslowcost',
    tags: ['E-commerce', 'Cloudinary', 'React'],
  },
  {
    id: 'p5', title: 'Bot IA YouTube + WhatsApp',
    desc: 'Bot que analiza tendencias de YouTube con Gemini y responde por WhatsApp.',
    url: '',
    github: 'https://github.com/pablo2389/Primer-MVP-bot-IA-tendencias-YouTube-Gemini-WhatsApp',
    tags: ['IA', 'Python', 'WhatsApp', 'Gemini'],
  },
  {
    id: 'p6', title: 'Presupuestos Albañilería',
    desc: 'Generador de presupuestos PDF según valores oficiales, envío por WhatsApp.',
    url: '',
    github: 'https://github.com/pablo2389/presupuestos-app',
    tags: ['Python', 'FastAPI', 'PDF'],
  },
  {
    id: 'p7', title: 'Alexis Alaniz – Boxeador',
    desc: 'Sitio personal con contacto por WhatsApp y enlace a Google Maps.',
    url: 'https://alanizboxing.netlify.app',
    github: 'https://github.com/pablo2389/alexis-alaniz',
    tags: ['HTML', 'CSS', 'JS'],
  },
  {
    id: 'p8', title: 'En Boca de Todos',
    desc: 'App de pedidos para rotisería con link directo a WhatsApp.',
    url: 'https://enbocadetodos.netlify.app',
    github: 'https://github.com/pablo2389/Enbocadetodos-',
    tags: ['Vanilla JS', 'Netlify'],
  },
  {
    id: 'p9', title: 'Tu Hondita Wave',
    desc: 'Sitio para venta de moto Honda Wave con ficha técnica y contacto.',
    url: 'https://tu-honditawave-jtxl.vercel.app',
    github: 'https://github.com/pablo2389/tuHonditawave',
    tags: ['React', 'Vercel'],
  },
  {
    id: 'p10', title: 'Cabañas Uspallata',
    desc: 'Página WordPress con SEO local optimizado.',
    url: 'https://uspallata.net/piletas-en-cabanas-uspallata/',
    github: '',
    tags: ['WordPress', 'SEO'],
  },
  {
    id: 'p11', title: 'Cabañas El Challao',
    desc: 'Landing promocional WordPress con gestión de contenidos.',
